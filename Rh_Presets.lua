...
local Presets = {
  ...
  { template = "readme",
    text = "&  — Неразрывный после коротких слов",
    name = "Nbsp after short words",
    data = {
      sSearchPat = [[([^\w](а|и|но|не|ни|в|к|о|с|у|во|до|за|из|ко|на|об|от|по|со|без|для|над|под|при|про|перед|после|сквозь|через))\x20]],
      sReplacePat = [[$1\xA0]],
      bExtended = true,
    },
  },
